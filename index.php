...
<main>
  ...
  <!-- <div class="container about">
    ...
    <div class="about__info">
      <p class="detail" href="#!">About me</p>
      <h1 class="display">Greetings!</h1>
  ...
  <!-- <div class="container projects">
    <div class="projects__header">
      ...
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste illum porro aperiam sit harum illo maiores distinctio voluptatibus incidunt natus et eos, repellendus eum! Ut nesciunt eum veniam minima hic.</p>
    </div>
